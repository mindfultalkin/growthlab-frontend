    ...
    try {
      ...
      if (file) {
        formData.append(
          "file",
          file,
          `${user?.userId}-${selectedCohortWithProgram?.cohortId}-${selectedCohortWithProgram?.program?.programId}-${subconcept?.subconceptId}.${file.name?.split(".")?.pop()}`
        );
      ...
      formData.append("programId", selectedCohortWithProgram?.program?.programId);
